...
In order to shape our initial Advanced Perlin device, we use a Layout Generator which allows us to build shapes that modify your terrain. You can use it as a shaping guide or as a mask for the layer.
